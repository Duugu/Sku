...
local function SplitString(aString)
	...
	aString = string.gsub(aString, "\\", ";\\;")
	aString = string.gsub(aString, "%(", ";klammer;auf;")
	aString = string.gsub(aString, "%)", ";klammer;zu;")
	aString = string.gsub(aString, "=", ";gleich;")
	aString = string.gsub(aString, "<", ";spitze;klammer;auf;")
	aString = string.gsub(aString, ">", ";spitze;klammer;zu;")
	aString = string.gsub(aString, "	", ";")
	aString = string.gsub(aString, "  ", " ")
	aString = string.gsub(aString, " ", ";")
	aString = string.gsub(aString, ";;", ";")
