...
local SkuQuestFixes = {
    ...
    [11153] = {
        [questKeys.extraObjectives] = {{{[zoneIDs.HOWLING_FJORD]={{28.1,42,2}}}, ICON_TYPE_EVENT, "Wait for Harrowmeiser's zeppelin to dock",}},
    },
    [11154] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, "Throw the firecrackers up to 20 yards away underneath a darkclaw bat to scare it", 0, {{"monster", 23959}}}},
    },
    [11157] = {
    ...
    [11249] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Present the Vrykul Scroll of Ascension", 0, {{"object", 186586}}}},
    },
    [11252] = {
        [questKeys.preQuestSingle] = {},
    },
    ...
    [11314] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Lurielle's Pendant on Chill Nymph", 0, {{"monster", 23678}}}},
    },
    [11332] = {
    ...
    [11358] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Rune Sample", 0, {{"object", 186718},}}},
    },
    [11366] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Rune Sample", 0, {{"object", 186718},}}},
    },
    ...
    [11410] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Fresh Barbfish Bait", 0, {{"object", 186770},}}},
    },
    [11418] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Feathered Charm on Steelfeather", 0, {{"monster", 24514},}}},
    },
    [11420] = {
        [questKeys.extraObjectives] = {{{[zoneIDs.HOWLING_FJORD]={{56.6,49,1}}}, ICON_TYPE_EVENT, "Entrance to Utgarde Catacombs",}},
    },
    [11429] = {
    ...
    [11466] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_TALK, "Talk to Olga", 0, {{"monster", 24639}}}},
    },
    [11471] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_SLAY, "Fight Jonah", 0, {{"monster", 24742}}}},
    },
    [11472] = {
    ...
    [11728] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Throw Wolf Bait",0,{{"monster", 25791}}}},
    },
    [11730] = {
    ...
    [11788] = {
        [questKeys.extraObjectives] = {
            {{[zoneIDs.BOREAN_TUNDRA]={{60,20.5},},}, ICON_TYPE_OBJECT, "Use Valve",0},
            {{[zoneIDs.BOREAN_TUNDRA]={{65.5,17.5},},}, ICON_TYPE_OBJECT, "Use Valve",1},
            {{[zoneIDs.BOREAN_TUNDRA]={{63.5,22.5},},}, ICON_TYPE_OBJECT, "Use Valve",2},
            {{[zoneIDs.BOREAN_TUNDRA]={{65.5,28.5},},}, ICON_TYPE_OBJECT, "Use Valve",3},
        },
    },
    [11798] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, "Use The Gearmaster's Manual",0,{{"object", 190334}}}},
    },
    [11878] = {
    ...
    [11956] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, "Ride Dusk",0,{{"monster", 26191}}}},
    },
    [11957] = {
        [questKeys.extraObjectives] = {
            {nil, ICON_TYPE_TALK, "Talk to Keristrasza",0,{{"monster", 26206}}},
            {{[zoneIDs.BOREAN_TUNDRA]={{22,22.6}}}, ICON_TYPE_EVENT, "Use Arcane Power Focus",},
        },
    },
    [11969] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Raelorasz' Spark",0,{{"object", 194151}}}},
    },
    [11982] = {
        [questKeys.preQuestSingle] = {},
    },
    [12017] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Tu'u'gwar's Bait",0,{{"object", 188370}}}},
    },
    [12019] = {
        [questKeys.extraObjectives] = {
            {{[zoneIDs.BOREAN_TUNDRA]={{86.6,28.6}}}, ICON_TYPE_EVENT, "Teleport to the top of Naxxanar",},
            {{[zoneIDs.BOREAN_TUNDRA]={{86.6,31.4}}}, ICON_TYPE_TALK, "Talk to Thassarian",},
        },
    },
    [12027] = {
    ...
    [12107] = {
        [questKeys.extraObjectives] = {
            {nil, ICON_TYPE_EVENT, "Use Ley Line Focus Control Talisman",0,{{"object", 188491}}},
            {nil, ICON_TYPE_EVENT, "Azure Dragonshrine observed",0,{{"object", 188474}}},
        },
    },
    [12135] = {
    ...
    [12327] = {
        ...
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Gossamer Potion",0,{{"object", 189972}}}},
    },
    [12330] = {
    ...
    [12532] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Capture Chicken Escapee", 0, {{"monster", 28161}}}},
    },
    [12536] = {
        [questKeys.triggerEnd] = {"Travel to Mistwhisper Refuge.",{[zoneIDs.SHOLAZAR_BASIN]={{46.31,39.88,},},},},
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_TALK, "Talk to Captive Crocolisk", 0, {{"monster", 28298}}}},
    },
    [12537] = {
    ...
    [12641] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, "Use Eye of Acherus Control Mechanism", 0, {{"object", 191609}}}},
    },
    [12665] = {
    ...
    [12674] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Quetz'lun's Hexxing Stick and slay him/her", 0, {{"monster", 28752},{"monster", 28754},{"monster", 28756}}}},
    },
    [12680] = {
        [questKeys.objectives] = {nil,nil,nil,nil,{{{28605,28606,28607},28605,"Horse Successfully Stolen"}}},
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Deliver Stolen Horse", 0, {{"monster", 28653}}}},
    },
    [12685] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Use Quetz'lun's Ritual", 0, {{"monster", 28672}}}},
    },
    [12687] = {
        [questKeys.triggerEnd] = {"The Horseman's Challenge",{[zoneIDs.PLAGUELANDS_THE_SCARLET_ENCLAVE]={{52.41,34.59,},},},},
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_SLAY, "Defeat Dark Rider of Acherus and take his horse", 0, {{"monster", 28768},{"monster", 28782}}}},
    },
    [12688] = {
    ...
    [12690] = {
        ...
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_OBJECT, "Use Scepter of Command", 0, {{"monster", 28843}}}},
    },
    [12697] = {
    ...
    [12698] = {
        ...
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Return Scarlet Ghouls", 0, {{"monster", 28658}}}},
    },
    [12701] = {
        [questKeys.extraObjectives] = {
            {nil, ICON_TYPE_OBJECT, "Climb inside the Inconspicuous Mine Car", 0, {{"object", 190767}}},
            {nil, ICON_TYPE_OBJECT, "Use the Scarlet Cannon", 0, {{"monster", 28833}}},
        },
    },
    [12720] = {
        [questKeys.triggerEnd] = {"\"Crimson Dawn\" Revealed",{[zoneIDs.PLAGUELANDS_THE_SCARLET_ENCLAVE]={{55.09,66.12},},},},
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_SLAY, "Equip Keleseth's Persuaders and persuade Scarlet Crusaders", 0, {{"monster", 28610},{"monster", 28936},{"monster", 28939},{"monster", 28940},}}},
    },
    [12721] = {
    ...
    [12754] = {
        [questKeys.extraObjectives] = {{{[zoneIDs.PLAGUELANDS_THE_SCARLET_ENCLAVE]={{60.9,75,5}}}, ICON_TYPE_EVENT, "Use the Makeshift Cover",}},
    },
    [12779] = {
        [questKeys.extraObjectives] = {{{[zoneIDs.PLAGUELANDS_THE_SCARLET_ENCLAVE]={{53.5,36.7}}}, ICON_TYPE_EVENT, "Use the Horn of the Frostbrood",}},
    },
    [12801] = {
        [questKeys.extraObjectives] = {
            {nil, ICON_TYPE_TALK, "Talk to Highlord Darion Mograine", 0, {{"monster", 29173}}},
            {{[zoneIDs.PLAGUELANDS_THE_SCARLET_ENCLAVE]={{38.8,38.4}}}, ICON_TYPE_EVENT, "The Light of Dawn Uncovered",},
        },
    },
    [12813] = {
    ...
    [12973] = {
        ...
        [questKeys.extraObjectives] = {{{[zoneIDs.STORM_PEAKS]={{39.6,56.4}}}, ICON_TYPE_EVENT, "Get in Brann Bronzebeard Flying Machine",}},
    },
    [13039] = {
    ...
    [13850] = {
        [questKeys.extraObjectives] = {{nil, ICON_TYPE_EVENT, "Melee attack Venomhide Ravasaur", 0, {{"monster", 6508}}}},
    },
    [14163] = {
